...
public class SignIn_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String message = "By continuing from here, you are indicating that you accept our Terms and Conditions and Privacy Policy.";
        ...
        spannable1.setSpan(clickableSpan1,64,84, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        spannable2.setSpan(clickableSpan2,89,103, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                        ...
                        db.collection("UserDetails")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    ...
                                    public void onSuccess(DocumentReference documentReference) {
                                        ...
                                        startActivity(i);
                                        Toast.makeText(SignIn_Activity.this, "Welcome to Good Thought", Toast.LENGTH_SHORT).show();
                                        SignIn_Activity.this.finish();
